...
process.env.PACT_WORKSHOP_COURSE_ID = process.env.PACT_WORKSHOP_COURSE_ID ?? "pact";
process.env.PACT_WORKSHOP_COHORT_ID = process.env.PACT_WORKSHOP_COHORT_ID ?? "pact-may-2026-2";
process.env.PACT_WORKSHOP_LOCKED = process.env.PACT_WORKSHOP_LOCKED ?? "false";

await import("./seedDay1Workshops.js");
